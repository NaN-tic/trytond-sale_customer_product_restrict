...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        # Activate sale_customer_product_restrict
        config = activate_modules('sale_customer_product_restrict')
        ...
        template2.product_customer_only = False
